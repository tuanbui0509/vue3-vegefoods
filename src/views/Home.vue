		...
		<section class="ftco-section ftco-category ftco-no-pt">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<div class="row">
							<div class="col-md-6 order-md-last align-items-stretch d-flex">
								<div class="category category-wrap-2 ftco-animate img align-self-stretch d-flex">
							...
							<div class="col-md-6">
								<div class="category-1 category-wrap ftco-animate img mb-4 d-flex align-items-end">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="#">Fruits</a></h2>
									</div>
								</div>
								<div class="category-2 category-wrap ftco-animate img d-flex align-items-end">
									<div class="text px-3 py-1">
					...
					<div class="col-md-4">
						<div class="category-3 category-wrap ftco-animate img mb-4 d-flex align-items-end">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="#">Juices</a></h2>
							</div>		
						</div>
						<div class="category-4 category-wrap ftco-animate img d-flex align-items-end">
							<div class="text px-3 py-1">
            ...
            <div class="carousel-testimony owl-carousel">
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="person-1 user-img mb-5">
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="person-2 user-img mb-5">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="person-3 user-img mb-5">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
